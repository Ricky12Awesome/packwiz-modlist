...
complete -c packwizml -s o -l output -d 'Specify a output file' -r
complete -c packwizml -s v -l log-level -d 'Sets the verbosity of logging' -r -f -a "{Off	,Error	,Warn	,Info	,Debug	,Trace	}"
complete -c packwizml -s c -l color-mode -r -f -a "{Auto	,Always	,Never	}"
complete -c packwizml -s f -l format -d 'Specify a custom format' -r
