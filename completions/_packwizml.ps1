...
Register-ArgumentCompleter -Native -CommandName 'packwizml' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'packwizml' {
            ...
            [CompletionResult]::new('-o', 'o', [CompletionResultType]::ParameterName, 'Specify a output file')
            [CompletionResult]::new('--output', 'output', [CompletionResultType]::ParameterName, 'Specify a output file')
            ...
            [CompletionResult]::new('--color-mode', 'color-mode', [CompletionResultType]::ParameterName, 'color-mode')
            [CompletionResult]::new('-f', 'f', [CompletionResultType]::ParameterName, 'Specify a custom format')
            [CompletionResult]::new('--format', 'format', [CompletionResultType]::ParameterName, 'Specify a custom format')
